  ...
  const MyStack=()=> {
    return (
      ...
      <Stack.Navigator>
        ...
        <Stack.Screen name="E&E Solutions" component={MyTabs} 
        options={({navigation})=>({
      ...
      <Tab.Navigator 
        ...
        <Tab.Screen name="Show All" component={AllOrdersTab} options={{
         ...
         <Tab.Screen name="Profile" component={ProfileTab} options={{
          tabBarIcon: ({ focused }) => {
            return (
              <Image source={require('../assets/images/profile.png')} style={{ width: 25, height: 25, tintColor: focused ? 'white' : '#9e9e9e' }} />
            )
