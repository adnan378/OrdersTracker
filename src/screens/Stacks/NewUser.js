...
const NewUser = ({navigation}) => {
  ...
  return (
    ...
    <View style={{flex:3,backgroundColor:'#eeeeee',borderTopLeftRadius:30,borderTopRightRadius:30,paddingVertical:30,paddingHorizontal:22}}>
      ...
      <Text style={{fontStyle:'italic',color:'#37474f',fontWeight:'900',fontSize:30}}>Register New User</Text>
    ...
    {/* <View style={{ marginVertical: 5}}>
        ...
        <View style={{ marginVertical: 5 }}>
          <Text style={{ fontWeight: 'bold', fontSize: 17, color: '#37474f' }}>Role :</Text>
        ...
        <View style={{marginVertical:20,marginRight:-8}}>
          <CustomButton title="Register" onPress={goToNextScreen} color='#37474f'/>
